...
bool ChasingScenario::init(dWorldID odeWorld, dSpaceID odeSpace, std::vector<boost::shared_ptr<Robot>> robot) {
...
bool ChasingScenario::afterSimulationStep() {
	...
	osg::Vec3 curPos = this->getRobots()[0]->getCoreComponent()->getRootPosition();
