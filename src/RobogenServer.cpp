...
// 					// }
// 					// std::vector<std::reference_wrapper<robogenMessage::Robot> > robots;
// 					// robots.push_back(packet.getMessage()->robot());
// 					// unsigned int simulationResult = runSimulations1(scenario,
